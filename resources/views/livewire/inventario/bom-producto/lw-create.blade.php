<div>
    ...
    <div class="modal-body relative p-4 ">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="form-group mb-6">
                <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-gray-700">Nombre del
                    producto</label>
                <input type="text" wire:model.defer="name" readonly
        ...
        <div class="grid grid-cols-3 gap-4">
            <div class="form-group mb-6">
                <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-gray-700">Materias
                    primas</label>
                <select wire:model.defer='materias_primas' name='materias_primas'
                ...
                <x-jet-input-error for="materias_primas" />
            </div>
            <div class="form-group mb-6">
                <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-gray-700">Cantidad</label>
                <input type="number" wire:model.defer="cantidad" name='cantidad'
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
            ...
            <div class="form-group mb-6">
                ...
                <input type="text" wire:model.defer="estado" name='estado'
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                    placeholder="Estado">
        ...
        <div
            ...
            <a type="button" href="{{ route('productos.show', $this->producto->id) }}"
