{{-- <div>
    <x-header-multi>
        <h6 class="font-medium leading-tight text-base">Añadir Maquinarias</h6>
    </x-header-multi>
    <div class="modal-body relative p-4 ">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="form-group mb-6">
                ...
                <input type="text" wire:model.defer="maquinarias.nombre" name='nombre'
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                    placeholder="Nombre">
                <x-jet-input-error for="maquinarias.nombre" />
            </div>
        ...
        <div class="form-group mb-6">
            ...
            <textarea name="marca" id="" cols="30" rows="5" placeholder="marca"
                wire:model.defer="maquinarias.marca"
            ...
            <x-jet-input-error for="maquinarias.marca" />
        </div>
        ...
        <div class="form-group mb-6">
            ...
            <textarea name="descripcion" id="" cols="30" rows="5" placeholder="descripción"
                wire:model.defer="maquinarias.descripcion"
                class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"></textarea>
            <x-jet-input-error for="maquinarias.descripcion" />
        </div>
    ...
    <div class="modal-body relative p-4 ">
        ...
        <div class="grid grid-cols-3 gap-4">
            <div class="form-group mb-6">
                ...
                <input type="text" wire:model.defer="maquinaria.descripcion" name='descripcion'
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
