<div class="m-1">
    <x-header-table>
        ...
        <div class="container-fluid flex">
            <div class="m-1 flex flex-row text-right">
                <a type="button" href="{{ route('dada-baja.create') }}"
                ...
                <ul class="dropdown-menu min-w-max absolute hidden bg-white text-base z-50 float-left
                    ...
                    <li>
                        <p class="dropdown-item flex text-sm py-2 px-4 font-normal w-full
                            ...
                            wire:click='order("cliente")'>codigo
                        </p>
                    </li>
                    <li>
                        <p class="dropdown-item flex text-sm py-2 px-4 font-normal w-full
    ...
    <x-table>
                ...
                <tbody>
                    @foreach ($bajas as $baja)
                        <tr class="bg-white border-b">
                            ...
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                {{ substr($baja->descripcion, 0, 50) }}
                            </td>
                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                {{ $baja->fecha }} - {{ $baja->hora }}
                            </td>

                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center justify-center">
                                    <div class="inline-flex" role="group">
                                        <a href="{{ route('dada-baja.show', $baja->id) }}"
        ...
        <x-pagination :modelo='$bajas'> </x-pagination>
    </x-table>
</div>
