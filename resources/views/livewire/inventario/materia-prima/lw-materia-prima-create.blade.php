<div>
    <x-header-multi>
        <h6 class="font-medium leading-tight text-base">Añadir Materia Prima</h6>
    </x-header-multi>
    <div class="modal-body relative p-4 ">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="form-group mb-6">
                ...
                <input type="text" wire:model.defer="materia.nombre" name='materia.nombre'
            ...
            <div class="form-group mb-6">
                ...
                <input type="text" wire:model.defer="materia.tipo" name='materia.tipo'
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                    placeholder="Tipo">
        ...
        <div class="grid grid-cols-1 gap-4">
            <div class="form-group mb-6">
                ...
                <textarea name="materia.descripcion" id="" cols="30" rows="5" wire:model.defer="materia.descripcion"
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="form-group mb-6">
                ...
                <input type="text" wire:model.defer="materia.tamaño" name='materia.tamaño'
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                    placeholder="Tamaño">
            ...
            <div class="form-group mb-6">
                ...
                <input type="text" wire:model.defer="materia.peso" name='materia.peso'
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                    placeholder="Peso">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="form-group mb-6">
                ...
                <input type="text" wire:model.defer="materia.color" name='materia.color'
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                    placeholder="Color">
            ...
            <div class="form-group mb-6">
                ...
                <input type="text" wire:model.defer="materia.cantidad" name='materia.cantidad'
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
            ...
            <div class="form-group mb-6">
                ...
                <select wire:model.defer='materia.idCategoriaMP' name='materia.idCategoriaMP'
        ...
        <div
            ...
            <a type="button" href="{{ route('materia-prima.index') }}"
