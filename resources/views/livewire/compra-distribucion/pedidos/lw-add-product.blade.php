<div>
    <x-header-multi>
        <h6 class="font-bold leading-tight text-base">Añadir Pedido</h6>
    </x-header-multi>
    <div class="modal-body relative p-4 ">
        <div class="grid grid-cols-2 gap-4">
            <div class="form-group mb-6">
                <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-gray-700">Cliente</label>
                <input type="text" wire:model.defer="cliente" name='fecha' readonly
            ...
            <div class="form-group mb-6">
                ...
                <input type="text" wire:model.defer="distribuidor" name='fecha' readonly
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                    placeholder="">
            </div>
        </div>
        ...
        <div class="bg-gray-100 p-3">
            ...
            <div class="grid grid-cols-5 gap-4">
                ...
                <div class="form-group col-span-2 mb-6">
                    ...
                    <input type="number" wire:model.defer="producto.cantidad" name='producto.cantidad' min="0"
                        class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        placeholder="00.00">
                                    ...
                                    <td
                                        ...
                                        <div class="flex items-center justify-center">
                                            <div class="inline-flex" role="group">
                                                <button type="button" wire:click='delete({{ $dproducto->id }} )'
