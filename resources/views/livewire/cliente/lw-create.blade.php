<div>
    <x-header-multi>
        <h6 class="font-medium leading-tight text-base">Añadir Cliente</h6>
    </x-header-multi>
    <div class="modal-body relative p-4 ">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="form-group mb-6">
                ...
                <input type="text" wire:model.defer="cliente.nombre" name='nombre'
            ...
            <div class="form-group mb-6">
                ...
                <input type="text" wire:model.defer="cliente.telefono" name='telefono'
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
        ...
        <div class="grid grid-cols-3 gap-4">
            ...
            <div class="form-group mb-6">
                ...
                <input type="text" wire:model.defer="cliente.direccion" name='direccion'
                    class="form-control block  w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
