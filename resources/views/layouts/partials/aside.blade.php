                                    ...
                                    <div class="px-1 rounded-md">
                                        <div class="flex items-center">
                                            ...
                                            <a href="{{ route('clientes.index') }}"
                                                class="w-full ml-2  text-sm font-semibold text-white">Permisos</a>
                                        </div>
                                    </div>
                                </li>
                                <li class="px-2 py-1 text-white transition-colors duration-150">
                                ...
                                <li class="px-2 py-1 text-white transition-colors duration-150">
                                    <div class="px-1  rounded-md">
                                        <div class="flex items-center">
                                            ...
                                            <a href="{{ route('materia-prima.index') }}" class="w-full ml-2  text-sm font-semibold text-white ">
                                                Materia Prima</a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="px-2 py-1 text-white transition-colors duration-150">
                                    <div class="px-1 rounded-md">
                                        <div class="flex items-center">
                                            ...
                                            <a href="{{ route('clientes.index') }}" class="w-full ml-2  text-sm font-semibold text-white">
                                                Clientes</a>
                                        </div>
                                    </div>
                                </li>
