                                ...
                                <li class="px-2 py-1 text-white transition-colors duration-150">
                                    <div class="px-1 rounded-md">
                                        <div class="flex items-center">
                                            ...
                                            <a href="{{route('clientes.index')}}" class="w-full ml-2  text-sm font-semibold text-white">Ver Clientes</a>
                                        </div>
                                    </div>
                                </li>
                                <li class="px-2 py-1 text-white transition-colors duration-150">
                                ...
                                <li class="px-2 py-1 text-white transition-colors duration-150">
                                    <div class="px-1  rounded-md">
                                        <div class="flex items-center">
                                            ...
                                            <a href="{{route('sistema-unidad.index')}}" class="w-full ml-2  text-sm font-semibold text-white ">Sistema de unidades</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
